    ...
    <>
      ...
      <div className="flex justify-center items-center mt-12 bg-gray-100">
        <div className="bg-white rounded-lg shadow-md p-8 w-full max-w-md">
          ...
          <p className="text-sm text-gray-500 text-center">Already have an account? <a href="/signin" className="text-red-500 hover:underline cursor-pointer">Sign in instead</a></p>
        </div>
